...
# Challenge Query 7 - select only by "ArtistId" #3 from the "Artist" table
# cursor.execute('SELECT * FROM "Artist" WHERE "ArtistId" = %s', [3])

#  Challenge Query 8 - select all tracks where the composer is
# "Blur" from the "Track"table - this shouldn't exist
cursor.execute('SELECT * FROM "Track" WHERE "Composer" = %s', ["Blurr"])
